...
export default function Detail() {
  ...
  const message = `Hello Alexandre, I'm getting in touch because I wanna help in the incident "${incident.title}," with an amount of ${Intl.NumberFormat('en-CA', {style: 'currency',currency: 'CAD'}).format(incident.value)}`
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contactBox}>
        ...
        <Text style={styles.heroTitle}>Be the hero of it</Text>
